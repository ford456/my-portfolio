                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-16'>
                    <div>
                        ...
                        <div className='space-y-6'>
                            ...
                            >
                                <a className='flex items-center gap-4 text-white hover:text-electric-blue transition-colors'
                                    ...
                                    <span className="font-body-md">patcharadol.soimanee@gmail.com</span>
                                </a>
                            </AnimatedContent>
                            <AnimatedContent
                                distance={30}
