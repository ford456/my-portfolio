...
export default function Card({
    ...
    return (
        <div>
            <div
                key={data.id}
                className="flex flex-col outline-0 outline-blue-400 mt-10 mb-2 mx-auto h-auto md:min-h-[400px]  max-w-[300px] 2xl:max-w-[1320px]
                 rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-105 hover:outline-2 hover:outline-blue-400 hover:outline-offset-4"
            >
                <img
