...
export default  function Page() {
  ...
  return (
    <main className="bg-none w-full h-auto flex justify-center items-center px-[140px] py-10 overflow-clip">
      <div className="grid grid-cols-1 h-[720px] xl:grid-cols-2 xl:gap-4 2xl:px-10 items-center">
            ...
            <form onSubmit={handleSubmit} className="border-gray-900 border-2 scale-50 md:scale-90 2xl:scale-100 rounded-2xl max-h-auto max-w-auto px-15 p-10">
              ...
              <div className="relative flex flex-col space-y-1">
                ...
                <textarea
                  ...
                  className="w-full h-auto px-4 py-2 border-2 border-black rounded-xl"
                />
              </div>
        ...
        <AnimatedContent
          ...
          <div className='hidden 2xl:flex 2xl:flex-col overflow-clip justify-center items-center'>
            ...
            <img src="https://res.cloudinary.com/donnu2idb/image/upload/v1774361429/%E0%B8%A3%E0%B8%B8%E0%B8%9B_dfcso1.png" alt="mypic" className=' rounded-full max-h-120 mb-5' />

            <ul className='flex flex-row gap-3'>
              <li><a href="https://www.facebook.com/Fxrd.dd/" target='_blank' ><FaFacebook className="text-3xl" /></a></li>
              <li><a href="https://www.instagram.com/friendaly.stu" target='_blank' ><FaInstagram className="text-3xl" /></a></li>
